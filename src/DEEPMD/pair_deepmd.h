...
#define GIT_SUMM v2.0.2-48-g2223ff3-dirty
#define GIT_HASH 2223ff3
#define GIT_BRANCH devel
#define GIT_DATE 2021-12-15 08:59:12 +0800
#ifdef HIGH_PREC
#define FLOAT_PREC double
#else
#define FLOAT_PREC float
#endif
#define DEEPMD_ROOT /scratch/gpfs/yifanl/usr/licensed/anaconda3/2020.7/dpdev3
#define TensorFlow_INCLUDE_DIRS /scratch/gpfs/yifanl/usr/licensed/anaconda3/2020.7/dpdev3/include;/scratch/gpfs/yifanl/usr/licensed/anaconda3/2020.7/dpdev3/include
#define TensorFlow_LIBRARY /scratch/gpfs/yifanl/usr/licensed/anaconda3/2020.7/dpdev3/lib/libtensorflow_cc.so;/scratch/gpfs/yifanl/usr/licensed/anaconda3/2020.7/dpdev3/lib/libtensorflow_framework.so
