...
class Verlet : public Integrate {
 public:
  ...
  double tbefore_initial = 0.0, tinitial_integrate = 0.0, tforce = 0.0, tafter_force = 0.0, tpost_force = 0.0, tfinal_integrate = 0.0, tend_of_step = 0.0, tfinal = 0.0, tbefore_pair = 0.0, tpair = 0.0, tafter_pair = 0.0, tdecide = 0.0, tbefore_clear_proc = 0.0, tbefore_clear = 0.0, tforce_clear = 0.0, tpre_force = 0.0, tmemset = 0.0, tbefore_memset = 0.0, tafter_memset = 0.0, treturn = 0.0, tnlocal = 0.0, tnbytes = 0.0, tnghost = 0.0;
